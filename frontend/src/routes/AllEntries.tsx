      ...
      {entries.map((entry: Entry, index: number) => {
        return (
          <div
            id={entry.id}
            key={index}
            className="bg-gray-300 dark:bg-gray-800 text-black dark:text-white shadow-md shadow-gray-500 dark:shadow-gray-700 m-3 p-4 rounded flex flex-col justify-between"
          >
            ...
            <section className="flex items-center justify-between flex-col md:flex-row pt-2 md:pt-0">
              <div className="flex justify-center">
                <button
                  ...
                  className="m-1 md:m-2 p-1 font-semibold rounded-md bg-red-500 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800"
                >
                  ✖
                </button>
                <button
                  ...
                  className="m-1 md:m-2 p-1 font-semibold rounded-md bg-blue-500 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700"
                >
                  🖊
                </button>
              </div>
